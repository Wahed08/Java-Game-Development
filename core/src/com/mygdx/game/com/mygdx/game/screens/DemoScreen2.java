...
public class DemoScreen2 implements Screen {

    MyGdxGame game;
    Texture texture;
    BitmapFont font;
    public  DemoScreen2(MyGdxGame game){
        this.game=game;
    ...
    public void render(float delta) {
        ...
        GlyphLayout layout = new GlyphLayout(font, "<- For left move \n\n-> For Right move\n\nSpace for Shooting\n\n", Color.BLACK, 0, Align.center, false);
